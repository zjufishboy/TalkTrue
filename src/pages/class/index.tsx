        ...
        <div className="ttCourse">
            ...
            <div className="ttCourseComment">
                <div className="ttCourseCommentOrState">
                    <div className={`ttCourseCommentOrStateItem ttCourseComment${ isTeacher?"On":"Off"}`} onClick={()=>{setIsTeacher(true)}}>课程</div>
                    <div className={`ttCourseCommentOrStateItem ttCourseComment${!isTeacher?"On":"Off"}`} onClick={()=>{setIsTeacher(false)}}>评价</div>
                </div>
                <div className="ttCourseList">
                    {
                    isTeacher ? 
                        teacherInfo.map((thr:TeacherInfo,index:number)=><TeacherItem teacherInfo={thr} key={index}/>)
                        :
